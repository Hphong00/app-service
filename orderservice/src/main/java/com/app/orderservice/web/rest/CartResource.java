...
/**
 * REST controller for managing {@link com.app.orderservice.domain.Cart}.
 */
@RestController
@RequestMapping("/api")
public class CartResource {
    ...
    private static final String ENTITY_NAME = "orderserviceCart";
     ...
     */
    @PutMapping("/carts/{id}")
    public ResponseEntity<CartDTO> updateCart(@PathVariable(value = "id", required = false) final UUID id, @RequestBody CartDTO cartDTO)
